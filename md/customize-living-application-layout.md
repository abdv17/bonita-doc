...
::: warning
Since 7.5 we made some improvement on the default layout.
...
So we propose here to add some new widget into the **Living application layout page**.
...
You can easily build a side menu layout. For this you need to start from a 7.4.x Layout and following the 7.4 documentation [customize-living-application-layout](/7.4?page=customize-living-application-layout#toc3)
